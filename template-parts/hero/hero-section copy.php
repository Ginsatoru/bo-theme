<?php
/**
 * Hero section component with scroll animations and image cards
 */
...
// Get image card settings
$card_1_image = get_theme_mod('hero_card_1_image');
$card_1_title = get_theme_mod('hero_card_1_title', 'Dog Food');
$card_1_link = get_theme_mod('hero_card_1_link', '/product-category/dog-food');

$card_2_image = get_theme_mod('hero_card_2_image');
$card_2_title = get_theme_mod('hero_card_2_title', 'Cat Food');
$card_2_link = get_theme_mod('hero_card_2_link', '/product-category/cat-food');

$card_3_image = get_theme_mod('hero_card_3_image');
$card_3_title = get_theme_mod('hero_card_3_title', 'Pet Toys');
$card_3_link = get_theme_mod('hero_card_3_link', '/product-category/pet-toys');
...
$default_card_image = get_template_directory_uri() . '/assets/images/card-placeholder.jpg';
...
<section class="<?php echo esc_attr($hero_class); ?>">
    ...
    <div class="hero-content-container">
        <div class="hero-content">
            ...
            <!-- Hero Image Cards - Moved inside hero-content -->
            <div class="hero-cards-wrapper" 
                 data-animate="fade-up" 
                 data-animate-delay="500">
                <div class="hero-cards-grid">
                    <!-- Card 1 -->
                    <a href="<?php echo esc_url($card_1_link); ?>" class="hero-card">
                        <div class="hero-card-image-wrapper">
                            <?php if ($card_1_image) : ?>
                                <?php echo wp_get_attachment_image($card_1_image, 'medium', false, array(
                                    'class' => 'hero-card-image',
                                    'alt' => esc_attr($card_1_title)
                                )); ?>
                            <?php else : ?>
                                <img src="<?php echo esc_url($default_card_image); ?>" alt="<?php echo esc_attr($card_1_title); ?>" class="hero-card-image">
                            <?php endif; ?>
                            <div class="hero-card-overlay"></div>
                        </div>
                        <div class="hero-card-content">
                            <h3 class="hero-card-title"><?php echo esc_html($card_1_title); ?></h3>
                        </div>
                    </a>

                    <!-- Card 2 -->
                    <a href="<?php echo esc_url($card_2_link); ?>" class="hero-card">
                        <div class="hero-card-image-wrapper">
                            <?php if ($card_2_image) : ?>
                                <?php echo wp_get_attachment_image($card_2_image, 'medium', false, array(
                                    'class' => 'hero-card-image',
                                    'alt' => esc_attr($card_2_title)
                                )); ?>
                            <?php else : ?>
                                <img src="<?php echo esc_url($default_card_image); ?>" alt="<?php echo esc_attr($card_2_title); ?>" class="hero-card-image">
                            <?php endif; ?>
                            <div class="hero-card-overlay"></div>
                        </div>
                        <div class="hero-card-content">
                            <h3 class="hero-card-title"><?php echo esc_html($card_2_title); ?></h3>
                        </div>
                    </a>

                    <!-- Card 3 -->
                    <a href="<?php echo esc_url($card_3_link); ?>" class="hero-card">
                        <div class="hero-card-image-wrapper">
                            <?php if ($card_3_image) : ?>
                                <?php echo wp_get_attachment_image($card_3_image, 'medium', false, array(
                                    'class' => 'hero-card-image',
                                    'alt' => esc_attr($card_3_title)
                                )); ?>
                            <?php else : ?>
                                <img src="<?php echo esc_url($default_card_image); ?>" alt="<?php echo esc_attr($card_3_title); ?>" class="hero-card-image">
                            <?php endif; ?>
                            <div class="hero-card-overlay"></div>
                        </div>
                        <div class="hero-card-content">
                            <h3 class="hero-card-title"><?php echo esc_html($card_3_title); ?></h3>
                        </div>
                    </a>
                </div>
            </div>
