...
(function() {
    ...
    class UniversalSlider {
        constructor(container, options = {}) {
            ...
            this.slidesContainer = container.querySelector('.testimonial-slides, .hero-slides, .slider-track');
            ...
            this.slides = Array.from(
                this.slidesContainer.querySelectorAll('.testimonial-slide, .hero-slide, .product-slide, .slider-item')
            );
