                                ...
                                <?php
                                    echo apply_filters(
                                        ...
                                        sprintf(
                                            ...
                                            esc_html__('Remove this item', 'macedon-ranges'),
                                            esc_attr($product_id),
                ...
                <tr>
                    <td colspan="6" class="actions">
                        <?php if (wc_coupons_enabled()) { ?>
                            <div class="coupon">
                                <label for="coupon_code"><?php esc_html_e('Coupon:', 'macedon-ranges'); ?></label>
                                ...
                                <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'macedon-ranges'); ?>"><?php esc_attr_e('Apply coupon', 'macedon-ranges'); ?></button>
                                <?php do_action('woocommerce_cart_coupon'); ?>
                            </div>
                        <?php } ?>

                        <button type="submit" class="button" name="update_cart" value="<?php esc_attr_e('Update cart', 'macedon-ranges'); ?>"><?php esc_html_e('Update cart', 'macedon-ranges'); ?></button>
